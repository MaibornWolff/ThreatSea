...
import { IconButton } from "#view/components/icon-button.component";
...
import { BigTextField } from "#view/components/big-textfield.component.jsx";
 ...
 */
const AddAssetDialog = ({ projectId, asset, userRole, ...props }) => {
    ...
    const [justificationDropDown, setJustificationDropDown] = useState(null);

    const handleJustificationDropDownChange = (field) => {
     ...
     * @param {object} errors
     */
    const handleJustificationErrors = (errors) => {
