...
const MeasureImpactByMeasureDialog = ({
    ...
    const handleConfirmDialog = (data: MeasureImpactFormValues) => {
        confirmDialog({
            ...
            threatId: parseInt(String(threat.id), 10),
            ...
            >
                                ...
                                >
                                    ...
                                    {filteredCatalogMeasures.map((catalogMeasure) => (
                                        <MenuItem
                                            ...
                                            onClick={(event) => handleImplementCatalogMeasure(event, catalogMeasure)}
                                        >
                                            {catalogMeasure.name}
                                        </MenuItem>
                                    ))}
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <DialogTextField
                        ...
                        placeholder={String(threat.probability)}
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <DialogTextField
                        ...
                        placeholder={String(threat.damage)}
