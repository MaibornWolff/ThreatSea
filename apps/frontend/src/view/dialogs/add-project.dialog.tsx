...
interface ProjectFormValues extends FormValues, Omit<Partial<Project>, keyof FormValues>, DialogValue {}
 ...
 */
const AddProjectDialog = ({ project, ...props }: AddProjectDialogProps) => {
     ...
     */
    const handleConfirmDialog = (data: ProjectFormValues) => {
        confirmDialog(data);
        closeDialog();
    };
