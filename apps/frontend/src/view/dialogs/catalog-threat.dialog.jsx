 ...
 */
const CatalogThreatDialog = ({ catalogThreat, isNew, ...props }) => {
    const navigate = useNavigate();
    const { confirmDialog, cancelDialog } = useDialog("catalogThreats");
    const {
        register,
        handleSubmit,
        control,
     ...
     *     from the dialog.
     */
    const handleConfirmDialog = (catalogThreat) => {
