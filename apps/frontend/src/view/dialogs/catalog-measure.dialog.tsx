...
type CatalogMeasureAttacker = ATTACKERS | ATTACKERS[] | null;
type CatalogMeasurePointOfAttack = POINTS_OF_ATTACK | POINTS_OF_ATTACK[] | null;

interface FormValues {
    id: number | undefined;
    name: string;
    description: string;
    attacker: CatalogMeasureAttacker;
    pointOfAttack: CatalogMeasurePointOfAttack;
    probability: number | "";
...
interface CatalogMeasureFormValues extends FormValues, Omit<Partial<CatalogMeasure>, keyof FormValues>, DialogValue {}

interface CatalogMeasureDialogProps extends DialogProps {
    catalogMeasure?: Partial<CatalogMeasure>;
    isNew: boolean;
    catalogId: number;
}
 ...
 */
const CatalogMeasureDialog = ({ catalogMeasure, isNew, catalogId, ...props }: CatalogMeasureDialogProps) => {
    const { cancelDialog, confirmDialog } = useDialog<CatalogMeasureFormValues | null>("catalogMeasures");
    ...
    const {
        ...
        handleSubmit,
        formState: { errors },
    } = useForm<CatalogMeasureFormValues>({
        defaultValues: {
            ...catalogMeasure,
            id: catalogMeasure?.id,
     ...
     *     from the dialog.
     */
    const handleConfirmDialog = (catalogMeasure: CatalogMeasureFormValues) => {
