        ...
        <Dialog onBackdropClick={handleCancelDialog} maxWidth="sm" fullWidth {...props} open={true}>
            ...
            >
                <Box sx={{ display: "flex", alignItems: "center", mt: 2, mb: 1 }}>
                    <FormControl
                        fullWidth
                        error={!!errors?.childThreatId}
                        data-testid="childThreatIdError"
                        sx={{
                            "&:hover fieldset": {
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <DialogTextField
                        ...
                        type="number"
                        margin="normal"
                        placeholder={probabilityPlaceholder ? String(probabilityPlaceholder) : t("noThreatSelected")}
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <DialogTextField
                        ...
                        type="number"
                        margin="normal"
                        placeholder={damagePlaceholder ? String(damagePlaceholder) : t("noThreatSelected")}
                        {...register("damage", {
                            required: {
