...
interface ErrorHeaderLocationState {
    project?: unknown;
}
...
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
     ...
     */
    handleOnCopyClick(event: React.MouseEvent<HTMLElement>, text: string): void {
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <IconButton
                                            ...
                                            onClick={(event) => this.handleOnCopyClick(event, error?.stack ?? "")}
                                        >
                                            <ContentCopyOutlined
                                                sx={{
                                                    fontSize: 14,
 ...
 */
const ErrorMenu = ({ children }: ErrorMenuProps) => {
    return (
        <Box
            sx={{
                display: "flex",
 ...
 */
const Header = () => {
    const { state } = useLocation() as Location<ErrorHeaderLocationState | undefined>;
    const { project } = state || {};
