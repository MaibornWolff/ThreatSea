...
import communicationInfrastructure from "#images/communication-infrastructure.png?inline";
import databaseWhite from "#images/database_white.png";
import database from "#images/database.png?inline";
import desktopWhite from "#images/desktop_white.png";
import desktop from "#images/desktop.png?inline";
import serverWhite from "#images/server_white.png";
import server from "#images/server.png?inline";
import userWhite from "#images/user_white.png";
import user from "#images/user.png?inline";
