...
import type { AugmentedSystemComponent } from "#application/selectors/system.selectors.ts";
...
type SelectAnchorHandler = (event: KonvaEventObject<MouseEvent>, payload: SelectAnchorPayload) => void;

type ConnectorAnchorSelectHandler = (event: KonvaEventObject<MouseEvent>, anchor: AnchorOrientation) => void;
...
interface SystemComponentProps extends Omit<AugmentedSystemComponent, "communicationInterfaces" | "pointsOfAttack"> {
    ...
    onSelectAnchor: SelectAnchorHandler;
...
interface ConnectorGroupProps extends Partial<GroupConfig> {
    selectedAnchor: AnchorOrientation | "";
    onSelectAnchor: ConnectorAnchorSelectHandler;
    width: number;
    height: number;
    children: ReactNode;
    hover: boolean | null;
...
const ConnectorGroup = ({
    ...
    const handleSelectAnchor: ConnectorAnchorSelectHandler = (event, anchor) => {
