...
import type { SystemComponent, SystemCommunicationInterface } from "#application/adapters/system-components.adapter.ts";
...
export type ConnectionEndpointWithComponent = SystemConnection["from"] & { component?: SystemComponent };
