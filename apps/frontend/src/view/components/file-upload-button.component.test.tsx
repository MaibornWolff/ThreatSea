...
describe("FileUploadButton", () => {
    it("should render its children as the button label", () => {
        renderWithProviders(<FileUploadButton id="upload">Upload file</FileUploadButton>);
        expect(screen.getByText("Upload file")).toBeInTheDocument();
    });

    it("should render a hidden file input", () => {
        renderWithProviders(<FileUploadButton id="upload">Upload</FileUploadButton>);
    ...
    it("should associate the label with the file input via id", () => {
        renderWithProviders(<FileUploadButton id="my-upload">Choose file</FileUploadButton>);
    ...
    it("should render without an id when none is provided", () => {
        renderWithProviders(<FileUploadButton>Upload</FileUploadButton>);
