...
import { Box, Button as MaterialButton, Collapse, Menu, MenuItem, Typography } from "@mui/material";
...
export const ProjectCard = ({ project, onClickEditProject, onClickDeleteProject, sx = {} }) => {
    const {
        t,
        i18n: { language },
    } = useTranslation("projectsPage");
    ...
    const handleEditProject = (e) => {
        onClickEditProject(e, project);
        handleClose();
    };

    const handleDeleteProject = (e) => {
        onClickDeleteProject(e, project);
        handleClose();
    };
